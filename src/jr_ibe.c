...
void jr_init(const EC_PAIRING p, mpz_t x, mpz_t y, mpz_t x0, mpz_t y0, mpz_t x1, mpz_t y1, mpz_t x2, mpz_t y2,
    EC_POINT G1, EC_POINT G2, EC_POINT G1alpha, Element z, EC_POINT u1, EC_POINT h1, EC_POINT w1){
...
void jr_ext(const EC_PAIRING p, const EC_POINT G2, const mpz_t x, const mpz_t x0, const mpz_t x1, const mpz_t x2, const mpz_t y, const mpz_t y0, const mpz_t y1, const mpz_t y2, const mpz_t I, EC_POINT D, EC_POINT Dx, EC_POINT Dxp, EC_POINT Dy, EC_POINT Dyp){
...
void jr_enc(const EC_PAIRING p, const mpz_t I, const Element m, const EC_POINT G1, const EC_POINT G1alpha, const Element z, const EC_POINT u1, const EC_POINT h1, const EC_POINT w1, mpz_t tag, Element Cm, EC_POINT Cx, EC_POINT Cy, EC_POINT C){
...
void jr_dec(const EC_PAIRING p, const EC_POINT D, const EC_POINT Dx, const EC_POINT Dxp, const EC_POINT Dy, const EC_POINT Dyp, const mpz_t tag, const Element Cm, const EC_POINT Cx, const EC_POINT Cy, const EC_POINT C, Element mp){
